...
Political violence scholars have failed to grapple with quotidian forms of violence, instead focusing on large, communally spectacular violence such as lynching. I introduce an original dataset on racial violence in the South from 1865 to 1871, detailing killings that occurred but also whippings, shootings, and other forms that were also prominent in the day-to-day repertoire but have historically been overlooked. As such, this is also among the first publicly available datasets which considers seriously violence committed by the first wave of the Ku Klux Klan. In introducing the Ghosthunter dataset, I substantively contribute to understandings of racial violence's spatio-temporal domains and demonstrate that killing, historically taken as the ur-action of the Klan, was only a part of actions undertaken by the Klan. As proof of concept, I test the recent thesis that the deployment of US troops led to racial violence as a backlash to US counterinsurgency policy in the Reconstruction-era US South. I find little evidence of a backlash effect in temporal proximity to those deployments, suggesting that we have not yet fully explained the South's racial violence problem.
