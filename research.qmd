...
1.  "Forged In Firing": The Creation of Identity in the Aftermath of Civil War
    ...
    ```{=html}
    <a href="https://www.dropbox.com/scl/fi/awejo6kb48cxjn0yoyl0e/FIF.pdf?rlkey=2tlj4l47nqnsdsapksnchab0s&st=qzx93hu5&dl=0">Working Paper Draft</a> | <a href="https://www.dropbox.com/scl/fi/83ki9rh39tuwa3ut4sljr/FIF-Appendices.pdf?rlkey=w16bol22zeo0dq4kq6vpo081z&st=jla0x51t&dl=0">Draft Appendices</a>
    ```
...
2.  "...ghosts never come back again" : Reconstruction and Racial Violence in the United States
 ...
 The American political era of Reconstruction is a black hole for data-driven inquiries over political violence in spite of large amounts of archived oral testimony and data-driven approaches to other forms of racial violence in the United States. To fill this gap, I introduce an original dataset on racial violence in the Southern United States from 1865 to 1871, detailing killings that occurred but also whippings, shootings, and other forms that were prominent in the day-to-day repertoire but historically been overlooked. Alongside its contributions to our understandings of racialized political violence, it is also among the first large-scale datasets on the first wave Ku Klux Klan and demonstrates that killing, historically taken as the ur-action of the Klan, was only a part of actions undertaken by the Klan. As proof of concept for the data's collection, I test the recent thesis that the deployment of US troops led to racial violence as a backlash to US counterinsurgency policy in the Reconstruction-era US South. I find little evidence of a backlash effect in temporal proximity to those deployments, suggesting we have much yet to learn about the modalities and effects of racialized political violence in the United States.
...
2.  Violence During Reconstruction

In a very early stage of development and on hiatus due to the dissertation, this project will use data from Congressional and state-level committees that operated in the Southern United States from 1865 to 1877 to ask three broad questions about political violence that occurred during Reconstruction: what did they do? who did it and how they do it? and when did they do it? While at first admittedly simple, the goal here is to systematically document political violence during Reconstruction in a data-first fashion. In so doing, my goal is also to more implicitly unite the political science literature on Reconstruction with the historical literatures on mass violence, the Klan, and the red shirts. While again, very early, my intuition from working on Ghosts and some other early work on this has been that political science and history are perhaps missing something in not integrating the study of these individual attacks, particularly non-lethal attacks, into our understandings of political violence in the United States.
